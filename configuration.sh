...
sudo pacman -Sy base-devel net-tools fuse linux-headers libuv mlocate xorg plasma-desktop sddm firefox plasma-nm plasma-pa dolphin xdg-user-dirs packagekit-qt5 konsole kdeplasma-addons kde-gtk-config egl-wayland zsh wget fd gdb pwndbg binwalk vscode virtualbox sddm-kcm --noconfirm
